...
class AdminAuditController {
  static async getDataEvidenceAAIT (req, res) {
    try {
      const evidence = await AdminAuditItModel.getDataEvidenceAAIT(req.params.year)
  ...
  static async getSelectAuditeeAAIT (req, res) {
    try {
      const role = req.query.role || 2
      const result = await AdminAuditItModel.getSelectAuditeeAAIT(role)
  ...
  static async updateDataAuditee (req, res) {
    ...
    try {
      ...
      const result = await AdminAuditItModel.updateDataAuditee(
        i_audevd,
        n_audusr_usrnm
      )
  ...
  static async getAuditeeAAIT(req, res) {
    try {
      const auditees = await AdminAuditItModel.getAuditeeAAIT();
  ...
  // static async getAuditeeAAIT (req, res) {
  //   try {
  //     const result = await AdminAuditItModel.getAuditeeAAIT()
  ...
  static async getDataRemarksAAIT (req, res) {
    ...
    try {
      const result = await AdminAuditItModel.getDataRemarksAAIT(key)
  ...
  static async updateStatusCompleteAAIT (req, res) {
    const key = req.body.I_AUDEVD
    try {
      const result = await AdminAuditItModel.updateStatusCompleteAAIT(key)
      if (result) {
        res
          .status(200)
  ...
  static async getDownloadFileAAIT (req, res) {
    try {
      const { fileId } = req.params
      const result = await AdminAuditItModel.getDownloadFileAAIT(fileId)
