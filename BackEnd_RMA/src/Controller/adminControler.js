...
class adminControler {
  ...
  async createKaryawan(req, res) {
    try {
      ...
      const result = await AdminModel.createKaryawan({ key, key1, roleInt });
  ...
  async deleteKaryawan(req, res) {
    try {
      ...
      const result = await AdminModel.deleteKaryawan(nik);
  ...
  async editKaryawan(req, res) {
    try {
      ...
      const result = await AdminModel.editKaryawan({
        n_audusr_usrnm,
        roleInt,
        N_AUDUSR
      });
