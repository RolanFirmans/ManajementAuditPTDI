...
class AdminAuditItModel {
  ...
  static async updateAuditee(i_audevd, n_audusr_usrnm) {
    const updateQuery = `
  ...
  static async getMenampilkanAuditee() {
    const result = await pool.query(`
  ...
  static async getDownloadFile (fileId){
